			...
			<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
				...
				<p id="account" class="pass-form-item" style="display:">
					...
					<c:if test="${empty sessionScope.openIdLocalId}">
						...
						<form:input id="username" name="username" class="pass-text-input pass-text-input-account" autocomplete="off" tabindex="1" accesskey="${userNameAccessKey}" path="username" htmlEscape="true"
							placeholder="邮箱" />
					</c:if>

					<span id="account_clearbtn" class="pass-clearbtn pass-clearbtn-account" style="display:none;"></span> <span id="accountError" class="pass-item-error pass-item-error-account"
						style="display: none;"></span> <span id="accountSucc" class="pass-item-succ pass-item-succ-account" style="display: none;"></span>
				</p>
				<p id="password" class="pass-form-item pass-form-item-password" style="display:">
					...
					<form:password id="password" name="password" class="pass-text-input pass-text-input-password" tabindex="2" path="password" accesskey="${passwordAccessKey}" htmlEscape="fase" autocomplete="off"
						placeholder="密码" />

					<span id="password_clearbtn" class="pass-clearbtn pass-clearbtn-password" style="display:none;"></span> <span id="passwordError" class="pass-item-error pass-item-error-password"
						style="display: none;"></span> <span class="pwd-strength-detail" style="display: none;">请输入密码</span> <span id="passwordSucc" class="pass-item-succ pass-item-succ-password" style="display:none;"></span>
				...
				<p id="isAgreeWrapper" class="pass-form-item pass-form-item-isAgree">
					<input name="isAgree" id="isAgree" type="checkbox" checked="checked" class="pass-checkbox-input pass-checkbox-isAgree" autocomplete="off"> <label style="float: left;">我已阅读并接受</label> <a
						target="_blank" href="#" style="float: left;">《知识库系统使用协议》</a>
				</p>
				<p id="submitWrapper" class="pass-form-item pass-form-item-submit">
					...
					<input type="hidden" name="lt" value="${loginTicket}" /> <input type="hidden" name="execution" value="${flowExecutionKey}" /> <input type="hidden" name="_eventId" value="submit" /> <input
						id="btn-submit" name="submit" class="pass-button pass-button-submit" accesskey="l" value="登录" tabindex="4" type="submit" />
				</p>
				<!-- 				</form> -->
			</form:form>
		</div>
		...
		<div id="reg_others">
			<div class="account3">
				...
				<ul class="account-detail">
					<li><a href="#" style="width: 120px; height: 24px;"> <img src="images_rdf/Connect_logo_3.png" />
					</a></li>
					<li></li>
				</ul>
			</div>
