			...
			<div id="bottom-inner">
				...
				<div class="global-bottom-left">
					<ul class="bottom-ul">
						...
						<li class="bottom-li-sub"><a href="${rdf_fronts_href}/home">首页</a></li>
						<li class="bottom-li-sub"><a href="${rdf_fronts_href}/register">注册</a></li>
						<li class="bottom-li-sub"><a href="#">登录</a></li>
						<li class="bottom-li-sub"><a href="${rdf_fronts_href}/protocal">使用协议</a></li>
					</ul>
				</div>
				<div class="global-bottom-left">
					<ul class="bottom-ul">
